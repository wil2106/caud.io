...
function FormDialog(props) {
  ...
  const handleSignUp = () => {
    ...
    if(!password.match(SAFEPASSWORDREGEX)){
      dispatch(setSignUpError('Password should contain at least 1 digit, one lower case, one upper case and 8 characters'))
      return;
    }

    dispatch(setSignUpError(''))

    dispatch(signMeUp(login, password, ()=> {
  ...
  return (
    ...
    >
      <DialogTitle><Box color="white" display="flex" justifyContent="center">Sign up</Box></DialogTitle>
      <DialogContent>
